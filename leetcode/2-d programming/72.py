...
BOTTOM UP 2D DP ARRAY - USE OUTER BOUNDS AND ESSENTIALLY IT'S A KNAPSACK PROBLEM
BUT REVERSED (MINIMISE A SET OF VALUES BEFORE YOU REACH THE START OF THE ARRAY [0,0])
"""
